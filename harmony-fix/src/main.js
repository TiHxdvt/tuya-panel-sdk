import { TopBar } from '@tuya-rn/tuya-panel-kit-harmony';
import { NavigatorLayout } from '@tuya-rn/tuya-panel-kit-harmony';
import { TYSdk } from '@tuya-rn/tuya-panel-kit-harmony';
...
import { rootEpics, rootReducers } from './redux/combine';

const epicMiddleware = createEpicMiddleware();

export const store = createStore(
  rootReducers,
  compose(applyMiddleware(epicMiddleware), f => f)
);
